    ...
    componentWillMount() {
       NetWork ? null : Alert.alert('网络似乎断掉了'), this.setState({isLoading: false});RouteName.push(this.props.navigation.state);
        ...
        if (this.props.navigation.state.params) {
            ...
            fetch(requestUrl.myCollectionInfo, {
                method: 'POST',
                headers: {
            ...
            <View style={styles.container}>
                ...
                <Nav navigation={this.props.navigation}
                     ...
                     data={{
                         ...
                         'rightBtn': {
                             type: 'btn',
                             'btnText': this.state.collectionType === '1' ? '已收藏' : '未收藏',
                ...
                >
                    ...
                    <View style={styles.titleBox}>
                        <Text style={styles.titleText}>会诊结论</Text>
                    </View>
                    <View style={styles.conclusionBox}>
                        ...
                        {/*<TouchableOpacity*/}
                        {/*onPress={()=>{*/}
                        {/*navigate('VideoPlay',{data: this.state.conclusionVideo})*/}
                        {/*}}*/}
                        {/*activeOpacity={.8}*/}
                        {/*>*/}
                        {/*<View style={styles.videoAplyBox}>*/}
                        {/*<Image source={require('../../images/videotape.png')}/>*/}
                        {/*<Text style={styles.videoText}>播放</Text>*/}
                        {/*</View>*/}
                        {/*</TouchableOpacity>*/}
                    </View>
