...
export default class GroupOrderInfo extends Component {
            ...
            <View style={styles.container}>
                ...
                >
                    ...
                    <View style={styles.titleBox}>
                        <Text style={styles.title}>病历附件</Text>
                    </View>
                    ...
                    <View style={styles.titleBox}>
                        <Text style={styles.title}>会诊备注</Text>
                    </View>
                    ...
                    <View style={styles.btns}>
                        ...
                        >
                            <View style={styles.btnBox}>
                                <Text style={styles.btnText}>会诊意见书</Text>
                            </View>
