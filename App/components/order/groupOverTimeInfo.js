            ...
            <View style={styles.container}>
                ...
                >
                    ...
                    <View style={styles.btns}>
                        {this.state.statusName === '会诊结束' ? null :
                            <TouchableOpacity
                                activeOpacity={.8}
                                onPress={() => {
                                    this.submit()
                            ...
                            >
                                <View style={styles.btnBox}>
                                    <Text style={styles.btnText}>申请延时</Text>
                                </View>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                ...
                                // navigate('ChatHistory', {data: this.state});
                            }}
                        >
                            <View style={styles.btnBox}>
    ...
    submit() {
        ...
        fetch(requestUrl.applyTimeout, {
            ...
            .then((responseData) => {
                ...
                if (responseData.status === '0') {
                    this.setState({loadingText: '已延长24小时'});
                    setTimeout(() => {
