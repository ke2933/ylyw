                        ...
                        <View style={styles.hospitalContent}>
                            <View style={styles.topBox}>
                                <View style={styles.hospitalBox}>
                                    <Text numberOfLines={1}
                                          style={styles.hospitalTitle}>{this.state.consultationHospitalName}</Text>
                                    {this.state.areaLable === this.state.myAreaID ? <View style={styles.areaLableBox}>
                            ...
                            <View style={styles.bottomBox}>
                                <View style={styles.hospitalLableContent}>
                                    ...
                                    </View> : <View style={styles.hospitalLabelBox}>
                                        <Text style={styles.hospitalLabelText}>普通医院</Text>
                                    </View>}
                                    {this.state.departmentLable > 0 ? <View style={styles.hospitalLabelBox}>
                                        <Text style={styles.hospitalLabelText}>顶级科室</Text>
                                    </View> : <View style={styles.hospitalLabelBox}>
                                        <Text style={styles.hospitalLabelText}>普通科室</Text>
                                    </View>}
                                </View>
                            ...
                            <View style={styles.doctorItem}>
                                <View style={styles.doctorItemTop}>
                                    <View style={styles.portraitBox}>
                                        ...
                                        {this.state.areaLable === this.state.myAreaID ?
                                ...
                                <View style={styles.doctorItemBottom}>
                                    <View style={styles.hospitalLableContent}>
                                        <View style={styles.hospitalLabelBox}>
                                            <Text style={styles.hospitalLabelText}>{this.state.hospitalLable}</Text>
                                        </View>
                                        <View style={styles.hospitalLabelBox}>
                                            <Text style={styles.hospitalLabelText}>{this.state.deptLabel}</Text>
                                        </View>
                                    </View>
